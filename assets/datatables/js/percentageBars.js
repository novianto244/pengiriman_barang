	...
	return function(d, type, row) {
	  ...
	  if (typeof d !== 'number' && typeof d !== 'string') {
		...
		if(d>=0 && d<=30){
			...
			var styleRule2 = 'border:1px '+bType+' '+cBorder+';line-height:16px;font-size:14px;color:'+cText+';background:'+cBack+';position:relative;';
			var styleRule3 = 'height:16px;line-height:12px;text-align:center;background-color:red;padding:auto 6px;';

			//Square is default, make template round if pShape == round
			if(pShape=='round'){
				styleRule2 += 'border-radius:3px;padding:1px;';
				styleRule3 += 'border-top-left-radius:3px;border-bottom-left-radius:3px;';
			}
			...
			var styleRule1 = 'max-width:100px;height:12px;margin:0 auto;';
			var styleRule2 = 'border:1px '+bType+' '+cBorder+';line-height:16px;font-size:14px;color:'+cText+';background:'+cBack+';position:relative;';
			var styleRule3 = 'height:16px;line-height:12px;text-align:center;background-color:orange;padding:auto 6px;';
			...
			var styleRule1 = 'max-width:100px;height:12px;margin:0 auto;';
			var styleRule2 = 'border:1px '+bType+' '+cBorder+';line-height:16px;font-size:14px;color:'+cText+';background:'+cBack+';position:relative;';
			var styleRule3 = 'height:16px;line-height:12px;text-align:center;background-color:yellow;padding:auto 6px;';
			...
			//Bar templates
			var styleRule1 = 'max-width:100px;height:12px;margin:0 auto;';
			var styleRule2 = 'border:1px '+bType+' '+cBorder+';line-height:16px;font-size:14px;color:white;background:'+cBack+';position:relative;';
			var styleRule3 = 'height:16px;line-height:12px;text-align:center;background-color:blue;padding:auto 6px;';
			...
			var styleRule1 = 'max-width:100px;height:12px;margin:0 auto;';
			var styleRule2 = 'border:1px '+bType+' '+cBorder+';line-height:16px;font-size:14px;color:white;background:'+cBack+';position:relative;';
			var styleRule3 = 'height:16px;line-height:12px;text-align:center;background-color:green;padding:auto 6px;';

			//Square is default, make template round if pShape == round
			if(pShape=='round'){
				styleRule2 += 'border-radius:3px;padding:1px;';
				styleRule3 += 'border-radius:3px;';
			}
